...
<div>
    <div class="grid-form1">
        ...
        <a href="{{ url('/all-parentcontent') }}" class="btn btn-primary float-end"> View All Parent Page Contents </a>

        @if(Session::has('parentcontent_added'))
        <p class="alert alert-success"> {{ Session::get('parentcontent_added') }}</p>
        @endif
        <form class="form-horizontal" action="{{ route('parentcontent.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="file" name="thumbnailimg" placeholder="image" onchange="previewFile(this)">
