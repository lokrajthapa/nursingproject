...
<div>
    <div class="grid-form1">
        ...
        @endif
        <form class="form-horizontal" action="{{ route('childcontent.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <select name="childpage_id" id="childpage_id" class="form-select form-select-sm">
